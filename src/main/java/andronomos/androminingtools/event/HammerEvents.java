package andronomos.androminingtools.event;
...
public class HammerEvents {
    ...
    private static final ResourceLocation CAN_HAMMER = new ResourceLocation("androminingtools", "can_hammer");
    private static final ResourceLocation CAN_SHOVEL = new ResourceLocation("androminingtools", "can_excavate");
